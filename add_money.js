const username = localStorage.getItem('nikku_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbynJ3LFkaLNuRtVHniUxO9FPd34wjlLdemVGbmR_NKPdrkc2eON_Cvt5fuHHgbEYgE/exec';
