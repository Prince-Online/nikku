const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxDQTMyK2-H-sJB2TbehdBjakXPiK961FNfhOmeU7o9WeQcf03Db6zhQYL3mXPes2Lo/exec";

if (localStorage.getItem('nikku_local')) {
...
async function submitData() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            localStorage.setItem('nikku_local', formData.username);
